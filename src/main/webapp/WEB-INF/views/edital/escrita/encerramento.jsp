...
<div id="contents" data-ng-controller="encerramentoController as ctrl">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/edital/encerramento.controller.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/edital/encerramento.dataService.js"></script>
