...
<div id="contents" data-ng-controller="listaController as ctrl">
   ...
   <div class="mdl-grid">
        <div class="mdl-cell mdl-cell--12-col page-header">
			<h3><spring:message code="edital.presenca.prova.title"/></h3>
		</div>
	</div>
   	...
   	<div class="mdl-grid">
        <div class="mdl-cell mdl-cell--12-col page-filter">
			<div class="left">
	            <input type="text" data-ng-change='ctrl.atualizaFiltro()' data-ng-model="filtros.nome" placeholder="<spring:message code='edital.presenca.prova.list.label.name.filter'/>" size="40"/>
			</div>
			<div class="right">
